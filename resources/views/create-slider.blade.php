                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Slider name" value="{{old('title')}}" required />
                                    </div>
                                </div>
                                <!-- <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Slider description</label>
                                        <textarea name="description" class="form-control" placeholder="Slider description">{{old('description')}}</textarea>
                                    </div>
                                </div> -->
                                <div class="col-sm-12">
                                    <div class="form-group">
