                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label style="background-color: darkgoldenrod;color: white;font-size: 18px;padding: 10px;border-radius: 5px;">Old Password is {{is_null($old_password->old_password) ? 'Not Set for now' : $old_password->old_password}}</label>
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>New Password*</label>
                                        <input type="password" name="new_password" class="form-control" placeholder="New Password" value="{{old('new_password')}}" required />
                                    </div>
                                </div>
                            </div>
                        </div>
