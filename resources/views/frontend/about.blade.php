		...
		<div class="container">
			<div class="row">
				<div class="col-lg-6 col-md-6">
					...
					<img src="{{asset('theme/images/about-img.jpg')}}" alt="Slideshow Image" class="img-fluid ">
				</div>

				<div class="col-lg-6 col-md-6 text-center">
					<div class="inner-column">
						<h1>{{__('site.welcome_to')}} <span>{{__('site.menu_restaurant')}}</span></h1>
						<br/>
