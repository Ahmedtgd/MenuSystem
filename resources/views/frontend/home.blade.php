    ...
    <div class="row">
        ...
        <div id="owl-main-section">
            ...
            <div class="owl-carousel" id="slider-menu">
                ...
                @endphp
                <div number-slide="{{$count_slide}}" class="slider-category-item <?= $count == 1 ? 'active' : ''?>" id="item-common-{{$category->id}}" target-section="common-{{$category->id}}" cat-id="{{$category->id}}"> 
                    <div id="5c07e7a245a4dc00139e8b43" height="135" class="box__Box-sc-1ou4qyg-0 dxfvZz">
                        <div class="slider-category-image" style="background-image: url('{{ $url }}');background-size: cover; background-position: center; background-repeat: no-repeat; height: 125px;"></div>
                            <div display="flex" height="45" class="box__Box-sc-1ou4qyg-0 kUVlyD">
                            <p class="slider-category-title mt-3">
                            	{{$locale == 'en' ? ucwords($category->title) : $category->title_ar}}
                            </p>
                        </div> 
                    </div>
                </div>
    ...
    <div class="row">
		<div class="col-md-12">
			<div class="ajax-products">
				...
				<img src="{{asset('theme/images/loader.svg')}}" />
			    </div>
