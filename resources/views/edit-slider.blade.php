                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Slider title" value="{{$slider->title}}" required />
                                    </div>
                                </div>
                                <!-- <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Slider Description</label>
                                        <input type="text" name="description" class="form-control" placeholder="Slider description" value="{{$slider->description}}" />
                                    </div>
                                </div> -->
                                <div class="col-sm-12">
                                    <div class="row">
                                ...
                                <!-- <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="{{ asset('uploads/slider/'.$slider->web_image) }}" width="100"/>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
