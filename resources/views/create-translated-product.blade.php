                            ...
                            <div class="row">
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <input dir="rtl" type="text" name="title" class="form-control" placeholder="Product name" value="{{old('title')}}" required />
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        <label>English Product Title</label>
                                        <input type="text" disabled="disabled" class="form-control" name="title_english" value="{{$product->title}}" />
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        <label>Translated Product Nutrition Info*</label>
                                        <textarea id="nutrition" dir="rtl" class="ckeditor form-control" name="nutritionInfo"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
                                        ...
                                        <div>
                                        <?php echo $product->nutritionInfo ?>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-sm-8">
                                    <div class="form-group">
                                        ...
                                        <textarea id="ingredients" dir="rtl" class="ckeditor form-control" name="ingredients"></textarea>
                                    </div>
                                </div>
                                <div class="col-sm-4">
                                    <div class="form-group">
