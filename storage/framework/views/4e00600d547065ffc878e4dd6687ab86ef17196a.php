...
<div class="content-wrapper" style="min-height: 375px;">
    ...
    <h3 class="m-0 text-center">Edit Slider</h3>
                            ...
                            <div class="row">
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Slider title" value="<?php echo e($slider->title); ?>" required />
                                    </div>
                                </div>
                                <!-- <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Slider Description</label>
                                        <input type="text" name="description" class="form-control" placeholder="Slider description" value="<?php echo e($slider->description); ?>" />
                                    </div>
                                </div> -->
                                <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?php echo e(asset('uploads/slider/'.$slider->image)); ?>" width="100"/>
                                        </div>
                                    </div>
                                </div>
                                <!-- <div class="col-sm-12">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                            <img src="<?php echo e(asset('uploads/slider/'.$slider->web_image)); ?>" width="100"/>
                                        </div>
                                    </div>
                                </div> -->
                            </div>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\feso beso\Documents\berbene2\berbene\resources\views/edit-slider.blade.php ENDPATH**/ ?>