                            ...
                            <div class="row">
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="title" class="form-control" placeholder="Category name" value="<?php echo e(old('title')); ?>" required />
                                    </div>
                                </div>
                                <div class="col-sm-12">
                                    <div class="form-group">
                                        <label>Category title Arabic*</label>
                                        <input type="text" name="title_ar" class="form-control" placeholder="Category arabic name" value="<?php echo e(old('title_ar')); ?>" required />
                                    </div>
                                </div>
...
<?php $__env->stopSection(); ?> 
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\feso beso\Documents\berbene2\berbene\resources\views/create-category.blade.php ENDPATH**/ ?>